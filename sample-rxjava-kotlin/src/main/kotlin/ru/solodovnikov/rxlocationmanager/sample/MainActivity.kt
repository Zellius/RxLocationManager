...
class MainActivity : AppCompatActivity(), BasePermissionBehavior.PermissionCallback {
    ...
    private fun requestBuild() {
        if (checkPermissions) {
            ...
            locationRequestBuilder
                    .addLastLocation(LocationManager.NETWORK_PROVIDER, LocationTime(30, TimeUnit.MINUTES), behaviors = permissionTransformer)
                    .addRequestLocation(LocationManager.NETWORK_PROVIDER, LocationTime(15, TimeUnit.SECONDS), behaviors = permissionTransformer)
    ...
    private fun requestBuildIgnoreSecurityError() {
        ...
        locationRequestBuilder
                .addLastLocation(LocationManager.NETWORK_PROVIDER, LocationTime(30, TimeUnit.MINUTES), behaviors = ignoreError)
                .addRequestLocation(LocationManager.NETWORK_PROVIDER, LocationTime(15, TimeUnit.SECONDS), behaviors = ignoreError)
                .setDefaultLocation(Location(LocationManager.PASSIVE_PROVIDER))
                .create()
                .testSubscribe("requestBuild")
    }
